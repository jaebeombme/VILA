...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Top-p for model inference"
    )
    ...
    if json_path:
        ...
        for sample in data:
            id = sample["id"]
            image_path = os.path.join(parent_path , sample["image_path"])
            question = sample["question"]
            pairs.append({"id": id, "image_path": image_path, "question": question})
        
        results = run_batch_inference(pairs=pairs, output_path=output_dir, temperature=temperature, top_p=top_p)
    else:
        ...
        results = run_batch_inference(image_dir=img_paths, prompt=prompt, output_path=output_dir, temperature=temperature, top_p=top_p)

    save_result_to_json(results, output_dir)

# python3 /home/hufsaim/VLM/VLM/m3/demo/0506.py --prompt "This MRI image contains glioma. Segment this tumor part." --input_dir /home/hufsaim/VLM/data/for_test/251020 --output_dir /home/hufsaim/VLM/data/for_test/251020 --temperature 1.5 --top_p 1.0
# python3 /home/hufsaim/VLM/VLM/m3/demo/0506.py --prompt "Is there the abnormality?" --input_dir /home/hufsaim/VLM/VLM/data/0527/tmp --output_dir /home/hufsaim/VLM/VLM/data/0527 