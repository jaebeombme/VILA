...
import argparse
from experts.expert_tcm import ExpertTCM
...
OUTPUT_PATH="/home/hufsaim/VLM/VLM/m3/demo/0704/w_expert"
...
class M3Inference:
    ...
    def inference(self, 
        ...
        **kwargs,
        ...
        output = "This looks like a MR Image. Let me first trigger <TCM()>."
        ...
        if expert_model:
            ...
            try:
                ...
                if instruction:
                    ...
                    # print(f'[DEBUG] Updated Prompt : {updated_prompt_text}')
