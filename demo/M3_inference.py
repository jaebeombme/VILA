...
# INPUT_DIR = "/home/hufsaim/VLM/VLM/data/BraTS/tmp/Brats18_2013_2_1"
INPUT_DIR = "/home/hufsaim/VLM/VLM/data/BrainTumorMRI/Testing/glioma/Te-gl_0012.jpg"
MODALITY="MRI"
JSON_FILE = None #"/home/hufsaim/VLM/VLM/data/BrainTumorMRI/dataset.json"
slice_index = 77
...
class M3Inference:
    def __init__(self, model_path="/home/hufsaim/VLM/VLM/Llama3-VILA-M3-8B/snapshots/df60e0276e2ae10624c86dabe909847a03b2a5cb", conv_mode="llama_3"):
        model_name = "Llama3-VILA-M3-8B"
...
def run_batch_inference(
        image_dir=None, 
        modality=None, 
        prompt="What MRI sequence is this image?",
        pairs=None
    ):
    inference_result = {}
...
if __name__ == "__main__":
    results = []
    if JSON_FILE:
        parent_path = os.path.dirname(JSON_FILE)
