...
class M3Generator:
    ...
    def __init__(self, source="huggingface", model_path="/home/hufsaim/VLM/VLM/Llama3-VILA-M3-8B", conv_mode="llama_3"):
    ...
    def process_prompt(self, prompt, sv, chat_history):
        ...
        for expert_model in [ExpertTXRV, ExpertVista3D, ExpertBrats, ExpertHDGLIO]:
