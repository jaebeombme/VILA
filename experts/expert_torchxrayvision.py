...
class ExpertTXRV(BaseExpert):
    ...
    def run(
        ...
        """
        # print(f'[DEBUG] CXR Model Inference')
        if not img_file:
            img = skimage.io.imread(image_url)
        else:
            img = np.array(Image.open(img_file[0]).convert('RGB'))
...
if __name__ == "__main__":
    ...
    image_path = ['/home/hufsaim/VLM/VLM/data/0527/slake_atelectasis_312.jpg']
    prompt = 'What diseases are included in the picture?'
